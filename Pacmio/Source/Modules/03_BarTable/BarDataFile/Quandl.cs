...
namespace Pacmio
{
    public static class Quandl
    {
        ...
        {
            bool use_quandl = bdf.Contract is Stock && bdf.Contract.Country == "US" && bdf.BarFreq == BarFreq.Daily && bdf.PriceType == PriceType.Trades;
                        ...
                        if (fields.Length == 14)
                        {
                            ...
                            if (lastSymbolName != currentSymbolName)
                            {
                                ...
                                if (symbolLUT.ContainsKey(currentSymbolName))
                                {
                                    ...
                                    currentBtd = BarDataFile.LoadFile((currentContract.Key, BarFreq.Daily, PriceType.Trades));
                                }
