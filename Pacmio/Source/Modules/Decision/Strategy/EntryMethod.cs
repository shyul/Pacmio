...
namespace Pacmio
{
    ...
    public class EntryMethod
    {
        ...
        /// </summary>
        protected Dictionary<(BarFreq BarFreq, DataType DataType), BarAnalysisSet> BarAnalysisSets { get; } = new Dictionary<(BarFreq BarFreq, DataType DataType), BarAnalysisSet>();
